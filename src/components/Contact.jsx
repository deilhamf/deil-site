            ...
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                ...
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                    ...
                    <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
                        Send me a message, and i&apos;ll be happy to respond!
                    </p>
                ...
                <form
                    action="https://getform.io/f/aejygexb"
                    method="POST"
                ...
                >
                    ...
                    <button
                        type="submit"
                        className="btn bg-purple-400 [&]:max-w-full w-full justify-center reveal-up"
                    >
                        Submit
                    </button>
